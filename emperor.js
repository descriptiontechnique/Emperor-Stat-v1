...
logs ( client );
let pub = "746342444945113158";
let priv = "746342445268336654"
let alone = "746342446279033014"
...
client.on ( "voiceChannelJoin" , ( member , channel ) => {
    ...
    if ( ! member.roles.cache.has ( "721687307618484305" ) ) return
    const json = {
        "channel" : channel.id ,
...
client.on ( "message" , async message => {
    ...
    const toplam = new Discord.MessageEmbed ()
       ...
       .setColor ( "RANDOM" )
        ...
        .setDescription ( `• (Sunucu İsmi) sunucusunun ses bilgileri aşağıdadır
